    ...
    return (
        <div className="">
            ...
            <div className="w-full flex justify-center mt-[80px] max-lg:mt-[52px]">
                <button type="button" onClick={handleShowMore} className="flex justify-center text-white bg-[#005D63] hover:bg-[#274b4f] rounded text-[18px] max-md:text-[14px] font-semibold px-[32px] py-4 mb-2" style={{ lineHeight: "166.67%" }}>
