                ...
                <div className="mx-[30px] pt-[30px]">
                    ...
                    <form>
                        <div className="mt-[3rem]">
                            ...
                            <input id="input-field" className="w-full" type="email" placeholder=" " />
                        </div>
                        <div className="mt-[3rem]">
                        ...
                        <div className="mt-[3rem]">
                            ...
                            <input id="input-field" className="w-full" type="password" placeholder=" " />
                        </div>
                        <div className="mt-[3rem]">
                    ...
                    <button className="flex items-center mt-6 " onClick={handleBack}>
                        ...
                        <span className="ml-3 text-[#566363] text-[16px] hover:text-[#a9c5c5]">Quay lại trang Login</span>
                    </button>
                    ...
                    <div>
                        <button aria-label="Continue with google" role="button" className="flex items-center w-[255px] h-[50px] mx-auto btn-signin pl-[13px]">
                            <img src="/src/images/image803.png" alt="" />
                            <p className=" ml-[13px] ">Continue with Facebook</p>
                        </button>
                        <button aria-label="Continue with google" role="button" className="flex items-center w-[255px] h-[50px] mx-auto btn-signin pl-[13px]">
                            <svg width="24px" height="24px" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button aria-label="Continue with twitter" role="button" className="flex items-center w-[255px] h-[50px] mx-auto btn-signin pl-[13px]">
